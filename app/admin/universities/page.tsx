...
export default function VuzListPage() {
    const vuzs = mockVuzs; // Or mockPrograms for the programs list
        ...
        return (
             <div className="container mx-auto py-10">
                 <div className="flex justify-between items-center mb-4">
                     <h1 className="text-3xl font-bold">Управление ВУЗами</h1>
    ...
    if (isError) {
        ...
        return <div className="container mx-auto py-10 text-red-600">Ошибка загрузки данных ВУЗов.</div>;
    }
        ...
        <div className="container mx-auto py-10">
             <div className="flex justify-between items-center mb-6">
                 ...
                 <Link href="/admin/universities/new" passHref legacyBehavior>
                     <Button>
                         <PlusCircle className="mr-2 h-4 w-4" /> Добавить ВУЗ
                     </Button>
                 </Link>
             </div>
            <DataTable columns={columns} data={vuzs || []} />
        </div>
    );
}